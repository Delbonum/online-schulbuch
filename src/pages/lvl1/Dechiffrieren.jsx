...
export default function Dechiffrieren() {
  return (
    <div className="text-style">
      ...
      <p className="mb-4">
        Du hast eine Nachricht abgefangen, die Julius Caesar an einen seiner Offiziere senden wollte. Allerdings ist die
        Nachricht völlig unverständlich:
        <br />
        <strong className="text-white">
          <b>"CLHKW HXFK CXUXHFN!"</b>
        </strong>
        <br />
        <br />
