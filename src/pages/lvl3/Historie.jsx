...
import trithemius from "../../img/trithemius.webp";
import bellaso from "../../img/bellaso.webp";
import vigenere from "../../img/vigenere.webp";

export default function Historie() {
  return (
    <div>
      <h1 className="text-2xl font-bold heading-style mb-4">Begegnungen mit Trithemius, Bellaso und Vigenère</h1>
      ...
      <div className="space-y-8 text-style">
        <div className="flex flex-col md:flex-row items-start gap-4">
          ...
          <p>
            ...
            <em>Polygraphiae libri sex</em> beschreibt er die sogenannte <strong>Tabula Recta</strong> – eine
            quadratische Tabelle mit 26 Zeilen, die jeweils um einen Buchstaben versetzt sind. Sie erinnert dich an
        ...
        <div className="flex flex-col md:flex-row-reverse items-start gap-4">
          ...
          <p>
            ...
            <strong>Chiffrierscheibe</strong>, schlägt aber vor, das Alphabet nicht regelmäßig, sondern mithilfe eines
            Geheimwortes zu verändern.<br></br>
            <br></br>
            Der erste Buchstabe des Geheimwortes bestimmt die Verschiebezahl für den ersten Klartextbuchstaben, der
            zweite Buchstabe die Verschiebezahl für den zweiten Klartextbuchstaben und so weiter. So wird für jeden
            Buchstaben ein anderes Geheimtextalphabet verwendet, das auf dem Schlüssel basiert.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start gap-4">
          ...
          <p>
            ...
            aber mit einem Twist: Anstelle der geordneten Zeilen verwendet er <em>verwürfelte Alphabete</em>.<br></br>
            <br></br>
            Seine Idee ist brillant, doch als du in der Zeit noch einige Jahrhunderte in die Zukunft reist, um zu
            überprüfen, ob Vigenères Idee auch später noch Anwendung findet, stellst du fest, dass dieser Vorschlag in
            Vergessenheit gerät. Stattdessen wird aber die ursprüngliche Form – die auf der Tabula Recta mit geordneten
            Buchstaben beruht – unter dem Namen <strong>Vigenère-Chiffre</strong> bekannt.<br></br>
            <br></br>
            Du notierst dir alles in deinem Zeitreise-Journal. Der nächste Schritt ist klar: Du willst verstehen, wie
            die Vigenère-Chiffre genau funktioniert - wie sicher sie ist und ob du sie vielleicht knacken kannst...
          </p>
        </div>
      </div>
    </div>
