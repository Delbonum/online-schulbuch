  ...
  return (
    <div>
      ...
      <div className="text-style mb-8">
        <p>
          Das Vigenère-Verfahren scheint dir ziemlich sicher zu sein – wesentlich sicherer als die monoalphabetischen
          Verfahren jedenfalls, die du zuvor kennengelernt hast. Aber ist es absolut sicher oder kann es unter Umständen
          immer noch geknackt werden?
        </p>

        <p className="mt-4">
          <em>'Was wäre, wenn ...'</em>, fragst du dich,{" "}
          <em>
            '... ich die Länge des Schlüsselwortes kennen würde? Könnte ich dann nicht wieder eine Häufigkeitsanalyse
            durchführen, indem ich Cluster bilde für alle Geheimtextbuchstaben, die mit dem gleichen Schlüsselbuchstaben
            chiffriert wurden?'
          </em>
        </p>
