...
import { KASISKI_CIPHERTEXT } from "./kasiskiCiphertext";
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row-reverse items-start gap-4">
        <img loading="lazy" src={babbage} alt="Babbage" className="illustration self-start" />
        <p className="mb-4">
          ...
          <br></br>
          <em>"Egal"</em>, sagst du dir. <em>"Was er herausgefunden hat, können auch andere herausfinden."</em> Und
          tatsächlich musst du nur weitere 9 Jahre in die Zukunft reisen, um dem Geheimnis auf die Spur zu kommen...
        </p>
      </div>

      <div className="flex flex-col md:flex-row items-start gap-4">
        <img loading="lazy" src={kasiski} alt="Kasiski" className="illustration self-start" />
        <p className="mb-4">
          ...
          Studierzimmer ein und zeigt dir eine exemplarische Vigenère-Verschlüsselung.
        </p>
      </div>
      ...
      <p className="mb-6">
        Kasiski führt näher aus:{" "}
        <em>
          "Wie du in diesem Beispiel erkennen kannst, kann es auf verschiedene Art und Weise zu Dopplungen kommen. Es
          kann immer wieder passieren, dass{" "}
          <strong className="text-green-600 font-bold">
            ein Klartext-Abschnitt mit dem gleichen Schlüssel-Abschnitt chiffriert wird, was selbstverständlich auch zu
            Dopplungen im Geheimtext führt
          </strong>
          . Natürlich muss das nicht immer der Fall sein:{" "}
          <strong className="text-blue-500 font-bold">
            Es kann auch Dopplungen im Klartext geben, die von unterschiedlichen Schlüsselbuchstaben chiffriert werden
            und dann im Geheimtext nicht mehr erkennbar sind
          </strong>
          . Man muss auch ein bisschen aufpassen, denn manchmal kann es auch vorkommen, dass{" "}
          <strong className="text-red-400 font-bold">Dopplungen im Geheimtext zufällig entstehen</strong>.<br></br>
          <br></br>
      ...
      <p className="mb-6">
        Wenn du die Schlüssellänge erfolgreich ermittelt hast, kannst du - genau wie du es dir vorher überlegt hast -
        zur Clusteranalyse übergehen: Dazu teilst du den Geheimtext in mehrere Kolonnen auf - und zwar so, dass jede
        Kolonne nur Buchstaben enthält, die mit dem gleichen Schlüsselbuchstaben chiffriert wurden. Anschließend kannst
        du für jede Kolonne die Häufigkeitsanalyse durchführen, um den Schlüssel zu ermitteln.
      </p>

      <p className="font-semibold mb-2">Häufigkeitsanalyse in Kolonnen:</p>
      <div className="bg-white/10 p-4 rounded mb-6">
        <KolonnenanalyseTool initialText={KASISKI_CIPHERTEXT} />
      </div>

      <p className="mb-6">
        Wenn du nun herausgefunden hast, welches der häufigste Buchstabe in jeder Kolonne ist, kannst du den Schlüssel
        ermitteln. Danach kannst du die Nachricht mit dem Schlüssel dechiffrieren und lesen.<br></br>
        <br></br>
      ...
      <div className="bg-white/10 p-4 rounded text-sm mb-6">
        <VigenereTool initialGeheimtext={KASISKI_CIPHERTEXT} />
      </div>
    </div>
  );
}
