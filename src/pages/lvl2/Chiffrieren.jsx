      ...
      <div className="flex flex-col md:flex-row items-start justify-between gap-6 text-style">
        <div className="flex-1">
          ...
          <p className="mb-4">
            ...
            hast.
            <i>
              "Das Ersetzungsverfahren ist eine mächtige Methode der Verschlüsselung. Es ersetzt jeden Buchstaben durch
              einen anderen, basierend auf einem geheimen Schlüsselalphabet."
            </i>
          </p>
          <p className="mb-4">
            <i>
              "Während das Caesar-Verfahren einfach nur Buchstaben verschiebt, ersetzt das Ersetzungsverfahren jeden
              Buchstaben durch einen anderen – und das nicht mehr mit einem festen Abstand, sondern ganz nach einem
